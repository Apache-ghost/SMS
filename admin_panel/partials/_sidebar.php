...
<div class="sidebar">
    ...
    <ul class="side-menu main-side-board">
        ...
        <li><a href="student_management.php"><i class='bx bxs-group'></i>Student Management</a></li>
        <li><a href="subjects.php"><i class='bx bx-book-bookmark'></i>Subjects</a></li>
        <li><a href="curriculum.php"><i class='bx bx-book-content'></i>Curriculum</a></li>
        ...
        <li><a href="announcements.php"><i class='bx bx-bullhorn'></i>Announcements</a></li>
