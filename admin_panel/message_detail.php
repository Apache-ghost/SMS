...
function loadMessage(messageId) {
    ...
    .then(data => {
        if (data.status === 'success' && data.data) {
            ...
            if (data.data.recipient_type === 'admin' && data.data.is_read == 0) {
                ...
                <div class="card-body">
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            ${msg.sender_type !== 'admin' ? `<span class="badge bg-info ms-2">${msg.sender_type}</span>` : ''}
                        </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            ${msg.recipient_type !== 'admin' ? `<span class="badge bg-info ms-2">${msg.recipient_type}</span>` : ''}
                        </div>
                        ${msg.student_fname ? `
                        <div class="col-md-6 text-end">
                            <strong>Regarding Student:</strong> ${escapeHtml(msg.student_fname + ' ' + msg.student_lname)}
                        </div>
                        ` : ''}
                    </div>
                    <hr>
                    ...
                    <div class="card mb-2 ms-4">
                        <div class="card-body">
                            <div class="d-flex justify-content-between mb-2">
                                <strong>${escapeHtml(reply.sender_name || 'Unknown')}</strong>
